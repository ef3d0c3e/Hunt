...
/**
 * Julien's kit's events
 */
public class KitJulienEvents implements Listener
{
	/**
	...
	public void onPlayerDropItem(PlayerDropItemEvent ev)
	{
		...
		new BukkitRunnable()
		{
			...
			public void run()
			{
				if (!hp.isOnline() || !hp.isAlive() || hp.getKit() == null || hp.getKit().getID() != KitID.JULIEN)
					return;
	...
	public void onRightClick(final PlayerInteractEntityEvent ev)
	{
		...
		if (clicked.getKit() == null || clicked.getKit().getID() != KitID.JULIEN)
			return;
